# Contributing to senaite.instruments

Third-party contributions are essential for keeping `senaite.instruments` continuously 
improving. We simply cannot access the huge number of platforms and myriad 
configurations for running `senaite.instruments`. We want to keep it as easy as 
...
The following is a set of guidelines for contributing to senaite.instruments, which is 
...
bugs](https://github.com/senaite/senaite.instruments/issues)? Do you have a
suggestion for improvement? Then by all means please [submit a new
issue](https://github.com/senaite/senaite.instruments/issues/new), and do not
hesitate to comment on existing [open
issues](https://github.com/senaite/senaite.instruments/issues).
...
platform (Operating System and version, how did you installed senaite.instruments
...
The list of [open issues](https://github.com/senaite/senaite.instruments/issues)
...
### Preliminaries
   ...
   2. [Fork senaite.instruments from GitHub](
   https://github.com/senaite/senaite.instruments/fork). This will copy the whole
   `senaite.instruments` repository to your personal account.
   ...
   the actual username of your GitHub account):
          ...
          $ git clone https://github.com/YOUR_USERNAME/senaite.instruments

   4. Your forked repository https://github.com/YOUR_USERNAME/senaite.instruments will 
   receive the default name of `origin`. You can also add the original 
   `senaite.instruments` repository, which is usually called `upstream`:

          $ cd senaite.instruments
          $ git remote add upstream https://github.com/senaite/senaite.instruments.git
...
```
$ git remote -v
origin    https://github.com/YOUR_USERNAME/senaite.instruments.git (fetch)
origin    https://github.com/YOUR_USERNAME/senaite.instruments.git (push)
upstream  https://github.com/senaite/senaite.instruments.git (fetch)
upstream  https://github.com/senaite/senaite.instruments.git (push)
```
...
Alternatively, you can merge `senaite.instruments`'s `master` into your branch:
...
request](https://github.com/senaite/senaite.instruments/compare/). Head to your
 ...
 * Add a changelog entry in [CHANGES.rst](https://github.com/senaite/senaite.instruments/CHANGES.rst)
