...
class masshunterexport(object):
    implements(IInstrumentExportInterface)
    title = "MasshunterExporter"
...
class masshunterimport(object):
    implements(IInstrumentImportInterface, IInstrumentAutoImportInterface)
    title = "MasshunterImporter"
...
class MasshunterCSVParser(InstrumentCSVResultsFileParser):
...
class MasshunterImporter(AnalysisResultsImporter):
